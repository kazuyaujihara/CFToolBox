        ...
        public IEnumerator<ReferenceInfo> GetEnumerator()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    for (; ; )
                    {
                        var refInfo = GetReferenceInfo(selection, ref cursor, ref copyright);
                        if (refInfo == null)
                            yield break;
...
#pragma warning restore 467
        ...
        private static bool IsEmpty(SubstanceInfo info)
        {
            return info.CASRN == null && info.CAIndexName == null;
        }
